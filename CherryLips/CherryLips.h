...
class MinioClient {
 public:
  ...
  typedef bool (*PFN_ReadObjectCallback)(const char* datachunk, size_t datalen,
                                         void* userData);
  typedef bool (*PFN_ProgressCallback)(double download_total_bytes,
                                       double downloaded_bytes,
                                       double download_speed,
                                       double upload_total_bytes,
                                       double uploaded_bytes,
                                       double upload_speed, void* userdata);
  typedef void (*PFN_GetTagsCallback)(const char* key, const char* value,
                                      void* userData);
  typedef void (*PFN_ListBucketsCallback)(const char* bucketName,
                                          void* userData);
